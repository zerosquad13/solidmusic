...
class Configs:
    ...
    CHANNEL_LINK = getenv("CHANNEL_LINK", "https://t.me/xproject13")
    GROUP_LINK = getenv("GROUP_LINK", "https://t.me/xxxsquad18plus")
    UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/zerosquad13/solidmusic")
